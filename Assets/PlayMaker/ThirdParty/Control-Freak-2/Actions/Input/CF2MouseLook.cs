...
namespace HutongGames.PlayMaker.Actions.CF2
{
	...
	public class CF2MouseLook : FsmStateAction
	{
		...
		float GetXRotation()
		{
			rotationX += ControlFreak2.CF2Input.GetAxis("Mouse X") * sensitivityX.Value;
		...
		float GetYRotation()
		{
			rotationY += ControlFreak2.CF2Input.GetAxis("Mouse Y") * sensitivityY.Value;
