...
namespace HutongGames.PlayMaker.Actions.CF2
	...
	public class CF2AxisEvent : FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			var x = horizontalAxis.Value != "" ? ControlFreak2.CF2Input.GetAxis(horizontalAxis.Value, ref this.cachedIdX) : 0;
			var y = verticalAxis.Value != "" ? ControlFreak2.CF2Input.GetAxis(verticalAxis.Value, ref this.cachedIdY) : 0;
