...
namespace HutongGames.PlayMaker.Actions.CF2
{
	...
	public class CF2GetAxisVector : FsmStateAction
	{
		...
		public override void OnUpdate()
		{
			...
			var h = (horizontalAxis.IsNone || string.IsNullOrEmpty(horizontalAxis.Value)) ? 0f : ControlFreak2.CF2Input.GetAxis(horizontalAxis.Value, ref this.cachedIdX);
			var v = (verticalAxis.IsNone || string.IsNullOrEmpty(verticalAxis.Value)) ? 0f : ControlFreak2.CF2Input.GetAxis(verticalAxis.Value, ref this.cachedIdY);
