...
namespace HutongGames.PlayMaker.Actions.CF2
{
	...
	public class CF2MouseLook2 : ComponentAction<Rigidbody>
	{
		...
		float GetXRotation()
		{
			rotationX += ControlFreak2.CF2Input.GetAxis("Mouse X", ref this.cachedIdX) * sensitivityX.Value;
		...
		float GetYRotation()
		{
			rotationY += ControlFreak2.CF2Input.GetAxis("Mouse Y", ref this.cachedIdY) * sensitivityY.Value;
